        ...
        <div className="p-12 md:p-20 flex flex-col justify-center bg-white/20">
          ...
          <form className="space-y-4" onSubmit={handleRegister}>
            ...
            <div className="space-y-1">
              ...
              <input required type="text" placeholder="John Doe" className="w-full bg-white/50 border border-white rounded-2xl px-6 py-4 text-[#0F172A] placeholder:text-slate-300 focus:outline-none focus:ring-4 focus:ring-violet-500/10 transition-all text-sm" />
            </div>

            {/* Email */}
            <div className="space-y-1">
              <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Email Address</label>
              <input required type="email" placeholder="name@company.com" className="w-full bg-white/50 border border-white rounded-2xl px-6 py-4 text-[#0F172A] placeholder:text-slate-300 focus:outline-none focus:ring-4 focus:ring-violet-500/10 transition-all text-sm" />
            </div>
            
            {/* Password */}
            <div className="space-y-1">
              <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Create Password</label>
              <input required type="password" placeholder="••••••••" className="w-full bg-white/50 border border-white rounded-2xl px-6 py-4 text-[#0F172A] placeholder:text-slate-300 focus:outline-none focus:ring-4 focus:ring-violet-500/10 transition-all text-sm" />
            </div>
