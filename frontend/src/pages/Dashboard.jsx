    ...
    <div className="min-h-screen w-full bg-[#E2E8F0] relative font-sans flex flex-col overflow-x-hidden touch-pan-y">
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full p-5 md:p-10 pt-24 md:pt-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white/40 backdrop-blur-2xl border border-white/60 rounded-[24px] p-6 shadow-lg transform-gpu">
          ...
          <div className="bg-white/40 backdrop-blur-2xl border border-white/60 rounded-[24px] p-6 shadow-lg transform-gpu">
            ...
            <p className="text-4xl md:text-5xl font-black text-emerald-600">
              {bestScore}<span className="text-2xl text-slate-400">/10</span>
            </p>
          </div>
        </div>
        ...
        <button
          ...
          className="group relative w-full bg-[#0F172A] text-white font-black px-8 py-5 md:py-6 rounded-2xl shadow-xl hover:scale-[1.02] active:scale-95 transition-all overflow-hidden mb-8 transform-gpu"
        >
        ...
        <div className="pb-10">
          ...
          {interviews.length === 0 ? (
            <div className="bg-white/40 backdrop-blur-2xl border border-white/60 rounded-[24px] p-10 text-center">
              <p className="text-2xl mb-2">🎯</p>
              <p className="font-black text-[#0F172A]">No sessions yet!</p>
            ...
            <div className="flex flex-col gap-4">
              {interviews.slice(0, 5).map((interview) => (
                <div
                  ...
                  className="bg-white/40 backdrop-blur-2xl border border-white/60 rounded-[24px] p-5 md:p-6 shadow-lg cursor-pointer hover:scale-[1.01] transition-all flex justify-between items-center transform-gpu"
                >
                  <div className="overflow-hidden mr-2">
                    <div className="flex gap-2 mb-2 flex-wrap">
                      ...
                      <span className="bg-[#0F172A] text-white text-[8px] md:text-[9px] font-black px-2 py-1 rounded-full uppercase">
          ...
          {interviews.length > 5 && (
            <button
              ...
              className="w-full mt-4 bg-white/40 border border-white/60 text-[#0F172A] font-black px-8 py-4 rounded-2xl hover:scale-[1.02] transition-all text-[10px] md:text-xs uppercase tracking-widest transform-gpu"
            >
              View All Sessions
            </button>
          )}
